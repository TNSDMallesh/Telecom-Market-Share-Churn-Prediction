...
if 'df_out' in locals() or 'df_out' in globals():
    ...
    if missing_cols:
        st.warning(f"⚠️ Missing columns: {', '.join(missing_cols)}. Please ensure these exist in your dataset.")
    else:
    ...
    st.warning("⚠️ No data available yet. Please upload or generate predictions above to continue this analysis.")
